Shader "Hidden/.poiyomi/• Poiyomi Toon •/AFK Mute-AFK Mute"
{
    Properties
    {
...
#define PROP_DETAILTEXINTENSITY 0.14
...
#define PROP_EMISSIVESCROLL_WIDTH 2
#define PROP_EMISSIVESCROLL_VELOCITY 1
